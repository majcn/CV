...
& \footnotesize{Developing closed business application, integrating branching model for mercurial, Bitbucket administrator, creating own hooks to prevent bad documented commits, wrong side merges,\dots} \\
...
& \footnotesize{Developing e-commerce product wit Ghermany.}\\
